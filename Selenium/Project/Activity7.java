...
public class Activity7 {
    ...
    public void ReadingAdditionalInformation() {
     ...
     // Hover over Leads
        ...
        // Additional Information icon (last column)
        WebElement listIcon = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//*[normalize-space()='List Icon']")));

        listIcon.click();
        wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        
        WebElement Cancel = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//*[normalize-space()='Cancel']")));

        Cancel.click();
        
     // Read phone number from popup
        WebElement phone = wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//scrm-phone-detail/a")));
